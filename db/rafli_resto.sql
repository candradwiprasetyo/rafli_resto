...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 03, 2016 at 01:18 AM
...
INSERT INTO `branches` (`branch_id`, `branch_name`, `branch_img`, `branch_desc`, `branch_address`, `branch_phone`, `branch_city`, `branch_type_id`) VALUES
(1, 'Margomulyo', '1443152710_3-giraffe-restaurant-website.jpg', 'Caband pertama23', 'Gilang rt 24 rw 7 kav gg mangga taman sidoarjo23', '214748364723', 'Sidoarjo23', 1),
(2, 'Gedangan', '', '-', '-', '-', '-', 2);
...
--
-- Table structure for table `transaction_internals`
--

CREATE TABLE `transaction_internals` (
  `transaction_internal_id` int(11) NOT NULL,
  `transaction_internal_code` varchar(100) NOT NULL,
  `transaction_internal_date` date NOT NULL,
  `pabrik_branch_id` int(11) NOT NULL,
  `cabang_branch_id` int(11) NOT NULL,
  `branch_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `transaction_internals`
--

INSERT INTO `transaction_internals` (`transaction_internal_id`, `transaction_internal_code`, `transaction_internal_date`, `pabrik_branch_id`, `cabang_branch_id`, `branch_id`) VALUES
(9, 'AS647H', '2016-02-03', 1, 2, 1);

-- --------------------------------------------------------

--
-- Table structure for table `transaction_internal_details`
--

CREATE TABLE `transaction_internal_details` (
  `transaction_internal_detail_id` int(11) NOT NULL,
  `transaction_internal_id` int(11) NOT NULL,
  `item_id` int(11) NOT NULL,
  `transaction_internal_detail_qty` int(11) NOT NULL,
  `transaction_internal_detail_price` int(11) NOT NULL,
  `transaction_internal_detail_total` int(11) NOT NULL,
  `user_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `transaction_internal_details`
--

INSERT INTO `transaction_internal_details` (`transaction_internal_detail_id`, `transaction_internal_id`, `item_id`, `transaction_internal_detail_qty`, `transaction_internal_detail_price`, `transaction_internal_detail_total`, `user_id`) VALUES
(25, 9, 6, 400, 5000, 2000000, 11),
(26, 9, 7, 300, 4000, 1200000, 11),
(29, 0, 6, 0, 0, 0, 11);
...
(1, 0, 11, 0, 1, 9000, 0, 9000, 1, 9000),
(2, 0, 11, 0, 13, 9000, 0, 9000, 1, 9000);
...
--
-- Dumping data for table `transaction_productions`
--

INSERT INTO `transaction_productions` (`transaction_production_id`, `branch_id`, `transaction_production_code`, `transaction_production_date`, `item_id`, `transaction_production_target`, `transaction_production_hasil`) VALUES
(5, 2, 'JDH67K', '2016-02-03', 6, 30, 20);

-- --------------------------------------------------------

--
-- Table structure for table `transaction_production_details`
--

CREATE TABLE `transaction_production_details` (
  `transaction_production_detail_id` int(11) NOT NULL,
  `transaction_production_id` int(11) NOT NULL,
  `item_id` int(11) NOT NULL,
  `transaction_production_detail_qty` int(11) NOT NULL,
  `user_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `transaction_production_details`
--

INSERT INTO `transaction_production_details` (`transaction_production_detail_id`, `transaction_production_id`, `item_id`, `transaction_production_detail_qty`, `user_id`) VALUES
(6, 5, 7, 50, 11);
...
--
-- Indexes for table `transaction_internals`
--
ALTER TABLE `transaction_internals`
  ADD PRIMARY KEY (`transaction_internal_id`);

--
-- Indexes for table `transaction_internal_details`
--
ALTER TABLE `transaction_internal_details`
  ADD PRIMARY KEY (`transaction_internal_detail_id`);
...
--
-- Indexes for table `transaction_production_details`
--
ALTER TABLE `transaction_production_details`
  ADD PRIMARY KEY (`transaction_production_detail_id`);
...
--
-- AUTO_INCREMENT for table `transaction_internals`
--
ALTER TABLE `transaction_internals`
  MODIFY `transaction_internal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `transaction_internal_details`
--
ALTER TABLE `transaction_internal_details`
  MODIFY `transaction_internal_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
...
--
ALTER TABLE `transaction_productions`
  MODIFY `transaction_production_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `transaction_production_details`
--
ALTER TABLE `transaction_production_details`
  MODIFY `transaction_production_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
